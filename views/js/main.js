...
var resizePizzas = function(size) {
  ...
  function changeSliderLabel(size) {
    switch(size) {
      case "1":
        document.getElementById("pizzaSize").innerHTML = "Small"; //replaced querySelector method by much faster method, getElementByID.
        return;
      case "2":
        document.getElementById("pizzaSize").innerHTML = "Medium"; //replaced querySelector method by much faster method, getElementByID.
        return;
      case "3":
        document.getElementById("pizzaSize").innerHTML = "Large"; //replaced querySelector method by much faster method, getElementByID.
        return;
      default:
  ...
  function determineDx (elem, size) {
    ...
    var windowWidth = document.getElementById("randomPizzas").offsetWidth; //replaced querySelector method by much faster method, getElementByID.
...
//Took this DOM traversal outside the loop and assigned it to a variable where it is computed only once.
var randPiz = document.getElementById("randomPizzas");

// This for-loop actually creates and appends all of the pizzas when the page loads
for (var i = 2; i < 100; i++) {
  randPiz.appendChild(pizzaElementGenerator(i));
}
